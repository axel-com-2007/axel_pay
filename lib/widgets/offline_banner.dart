...
// offline-critiques (§7.6)
// ============================================================
// Extrait de `_buildBandeauHorsLigne` (dashboard_screen.dart) pour être
// réutilisé tel quel par tous les écrans qui consomment un
// `CachedResult` (prépayé, postpayé, compteurs, détail contrat...),
// plutôt que de dupliquer le même widget dans chaque fichier.
//
...
// (`CompteurModel.freshnessLabel`) : ce bandeau donne une vue globale
// immédiate, l'autre donne le détail par carte.
// ============================================================
...
/// Bandeau utilisé côté écran de paiement (§7.6 : "aucune opération
/// financière n'est autorisée sans connexion active"). Volontairement
/// distinct d'[OfflineBanner] : il n'indique pas une fraîcheur de
/// donnée mais bloque une ACTION, donc un ton et une icône différents
/// (danger plutôt que warning), sans date de synchronisation.
